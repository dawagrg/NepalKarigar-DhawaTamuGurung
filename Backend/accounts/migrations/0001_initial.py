    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('karigar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='karigar', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer', to=settings.AUTH_USER_MODEL)),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.skill')),
            ],
        ),
    ]
